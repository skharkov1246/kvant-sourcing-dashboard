...
# Пометки незнания. Первые девять пришли из каталога позиций, остальные — из
# поля «бренд» таможенных декларациях: там незнание пишут словами «ОТСУТСТВУЕТ»
# (12 130 строк из 42 314 — самый частый «бренд» во всей выборке), «НЕ ОБОЗНАЧЕН»
# и «НЕ ОБОЗНАЧЕНА». Без них фильтр «настоящее имя изготовителя» пропускал их в
# справочник компаний: 2 257 брендов из 2 313, включая три этих.
OEM_JUNK = frozenset(("прочие", "прочий oem", "прочее", "не указан", "неизвестно",
                      "разные", "различные", "n a", "na", "нет данных",
                      "отсутствует", "отсутствуют", "не обозначен", "не обозначена",
                      "не обозначено", "без бренда", "без товарного знака",
                      "товарный знак отсутствует", "бренд отсутствует",
                      "марка отсутствует", "не имеет", "нет"))
