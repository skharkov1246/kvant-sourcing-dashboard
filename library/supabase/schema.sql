...
-- и снимается она одной правкой запроса. Аргумент — любое написание: ключ
-- считается внутри. Пустой ключ правдоподобен: пустоту отсеивают свои проверки.
-- Одно выражение без подзапроса — функция встраивается в запрос планировщиком.
