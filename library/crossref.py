...
def собрать(предложения, каталог=(), аналоги=(), машины=(), изготовители=(),
    ...
    return {
        ...
        "totals": {
            ...
            # Позиции без выбора, о которых нас спрашивали: это и есть список
            # работы по рассылке вторым поставщикам.
            "no_choice_with_demand": sum(
                1 for p in позиции
                if p["co"] < 2 and (p.get("demand") or {}).get("deals")),
