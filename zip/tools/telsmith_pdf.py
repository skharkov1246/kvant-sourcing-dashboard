#!/usr/bin/env python3
"""HTML → PDF для zip/orders/ТЕЛСМИТ-СОРСИНГ.html (Chromium через Playwright, A4 альбом)."""
import asyncio
import os
import sys
...
SRC = ROOT / "orders" / "ТЕЛСМИТ-СОРСИНГ.html"
DST = ROOT / "orders" / "ТЕЛСМИТ-СОРСИНГ.pdf"
