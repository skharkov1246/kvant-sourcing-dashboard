#!/usr/bin/env python3
"""HTML → PDF для zip/orders/CAT-СТОКИ-СОРСИНГ.html (Chromium через Playwright, A4 альбом)."""
import asyncio
import os
import sys
...
SRC = ROOT / "orders" / "CAT-СТОКИ-СОРСИНГ.html"
DST = ROOT / "orders" / "CAT-СТОКИ-СОРСИНГ.pdf"
