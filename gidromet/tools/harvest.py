...
PRIZNAKI = {
    ...
    'economy':   [(r'порог окупаемост', 10), (r'Карабашмед', 10), (r'база сравнени', 8),
                  (r'удержани\w* покупател', 8), (r'8\s*[—–-]\s*19', 6), (r'продажа концентрата', 5)],
    ...
    'voprosy':   [(r'что меняется от ответа', 20), (r'адресат', 14), (r'срок ответа', 12),
                  (r'вопрос\w* к заказчику', 8)],
}
