...
def main() -> int:
    ...
    steps += [
        # ПЕРЕД ВСЕМ ОСТАЛЬНЫМ ИЗ ЭТОГО БЛОКА: файлы, которые читают тесты, должны
        # быть в репозитории, а не только на диске. 22.09.2026 страница
        # public/nomenclature.html прошла зелёный preflight и уронила гейт —
        # `.gitignore` глушит `public/*.html`, а исключения заведены поимённо.
        # Локально тест открывал файл с диска, на раннере файла не было вовсе.
