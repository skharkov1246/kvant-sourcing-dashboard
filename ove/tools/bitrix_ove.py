...
# Сделка ОВЭ-75 в CRM: «БИ ОВЭ-75» (создана 01.09.2026, подтверждена владельцем).
# Запросы ТКП-кампании привязываются к ней полем «ID сделки» (ufCrm18_1723386389) —
# тянем их отдельным блоком для плитки на Дашборде.
OVE_DEAL_ID = 23008
