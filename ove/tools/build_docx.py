...
def build() -> Path:
    ...
    body = [
        ...
        p([run(f"Основание: ТЗ на БИ v3.6 и приложения №1–7. Составлено {today}. "
        ...
        p([run("Как работать с документом: пройти позиции с Заказчиком, зафиксировать по каждой, "
               "какая редакция верна (или иное решение), в строке «Решение Заказчика». Живая версия "
               "реестра с теми же номерами — на сайте проекта, вкладка «Расхождения ТЗ»; решения, "
               "внесённые там, попадают в общую базу и в следующую редакцию этого документа.", size="20")]),
