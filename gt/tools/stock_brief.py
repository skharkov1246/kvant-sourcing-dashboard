...
названное количество, потому что продавцов несколько. Их 197 на 2 757 775 USD —
это самые дорогие деньги заявки, которые двигаются БЕЗ поиска: искать ничего не
надо, продавец и страница уже названы, надо открыть её и решить одно — остаток
это или срок поставки.
...
решают, можно ли везти. Пока остаток спорный, строка в неё не идёт, и 2,76 млн
USD висят между «есть цена и адрес» и «отгружаема».
