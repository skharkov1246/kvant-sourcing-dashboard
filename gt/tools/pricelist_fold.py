...
РАЗДЕЛИТЕЛЬ РАЗРЯДОВ ПРОВЕРЯЕТСЯ НА САМОМ ЛИСТЕ, до чтения любой цены, и
проверяется СЧЁТОМ, а не парой примеров. По этому прейскуранту проверка дала
три независимых признака: у всех 14 745 значений после запятой ровно две цифры
и ни одного исключения; точка встречается в 2 900 строках и ВСЕГДА группами
ровно по три цифры, групп другой длины нет; точка всегда стоит левее запятой.
Плюс соседние строки одной страницы: «01810411 Safety plate 6,00» против
«01170411 POWER PACK 35.100,00», и заголовок колонки «P/N Description Unit
price - €». Вывод: точка — тысячи, запятая — центы, валюта евро. Ошибка в
разделителе дала бы стократное расхождение — именно так уже едва не случилось
на другом листе.

ДАТА БЕРЁТСЯ ИЗ ДОКУМЕНТА, А НЕ ИЗ ИМЕНИ ФАЙЛА. У этого прейскуранта год стоит
в колонтитуле каждой из 284 страниц, под адресом завода. Имя файла на площадке
публикации доказательством не является: его пишет тот, кто выложил.
