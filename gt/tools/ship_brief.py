...
def build() -> str:
    ...
    if invrows:
        ...
        a("<div class='warn'><p><b>Число файлов — не покрытие, и это измерено.</b> Прогон по "
          "слову «ЛУКОЙЛ» обошёл 137 сделок и разобрал 674 файла (128 994 строки), извлёк 2 153 "
