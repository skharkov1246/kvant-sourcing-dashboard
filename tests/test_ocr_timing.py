...
шумный лист 3024×4032 за 1,2 с, а ЧЕТЫРЕ таких же процесса разом не укладываются
и в 400 с. В /proc у каждого процесса четыре потока — tesseract собран с OpenMP и
сам берёт все ядра, поэтому четыре процесса дают шестнадцать потоков на четырёх
ядрах.
